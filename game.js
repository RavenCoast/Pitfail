...
class TinySynth {
  constructor() {
    ...
    this.noteIndex = 0;
    this.themes = {
      0: { tempo: 205, melody: [392, 440, 523, 659, 587, 523, 494, 659], bass: [131, 147, 165, 196], percussion: [1, 0, 1, 0, 1, 1, 0, 1] },
      1: { tempo: 196, melody: [415, 494, 554, 698, 622, 554, 523, 698], bass: [139, 156, 175, 208], percussion: [1, 0, 1, 0, 1, 0, 1, 1] },
      2: { tempo: 200, melody: [370, 440, 494, 659, 554, 494, 466, 622], bass: [123, 139, 156, 185], percussion: [1, 1, 0, 1, 0, 1, 0, 1] },
      cave: { tempo: 214, melody: [330, 392, 440, 523, 494, 440, 392, 523], bass: [110, 123, 131, 147], percussion: [1, 0, 1, 0, 1, 0, 1, 0] },
    };
  }
  ...
  setTheme(themeKey) {
    ...
    this.musicTimer = setInterval(() => {
      ...
      this.beep(m, 0.13, "square", 0.07);
      this.beep(b, 0.18, "triangle", 0.045);
      if (drum) this.playDrum(0.05 + drum * 0.008);
      this.noteIndex++;
    }, theme.tempo);
  }
}
